		...
		<div id="container">
			<div id="logo">
				<p><?php 
					...
					if (!isset($_GET['nazwa']))
						header("Location: http://borg.kis.agh.edu.pl/~kogukrzy/blogJS/all_blogs.php");
					else if (err404())
						header("Location: http://borg.kis.agh.edu.pl/~kogukrzy/blogJS/error.php?err=404");
					else
						echo $_GET['nazwa'];
				?></p>
			</div>
					...
					<?php
						...
						if (err404()) {
							...
							for ($i = 0; $i < $post_count; $i++) {
								...
								$comment_form_address = "http://borg.kis.agh.edu.pl/~kogukrzy/blogJS/comment_blog.php";
							...
							echo '<form action="http://borg.kis.agh.edu.pl/~kogukrzy/blogJS/add_post.php">';
