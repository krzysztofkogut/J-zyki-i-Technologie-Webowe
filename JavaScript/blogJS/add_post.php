			...
			<div id="content">
				<div id="blog" class="padd-left">
					<form action="./wpis.php" method="post" enctype="multipart/form-data">
						...
						<p class="reset-format">Data:<br /><input type="text" name="date" onchange="sprawdzPoprawnoscData()" value="<?php echo date("Y-m-d"); ?>"/></p>
						<p class="reset-format">Godzina:<br /><input type="text" name="time" onchange="sprawdzPoprawnoscGodzina()" value="<?php echo date("G:i"); ?>" /></p>
