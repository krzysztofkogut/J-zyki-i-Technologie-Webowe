		...
		<div id="container">
			<div id="title" class="main">
				<p><?php 
					...
					if (!isset($_GET['nazwa']))
						header("Location: http://student.agh.edu.pl/~polarczy/blog/all_blogs.php");
					else if (err404())
						header("Location: http://student.agh.edu.pl/~polarczy/blog/error.php?err=404");
					else
						echo $_GET['nazwa'];
				?></p>
			</div>
					...
					<?php
						...
						if (err404()) {
							...
							for ($i = 0; $i < $post_count; $i++) {
								...
								$comment_form_address = "http://student.agh.edu.pl/~polarczy/blog/comment_blog.php";
							...
							echo '<form action="http://student.agh.edu.pl/~polarczy/blog/add_post.php">';
